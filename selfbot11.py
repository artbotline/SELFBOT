...
cl = LINETCR.LINE()
cl.login(token="Eru6DvcCjVHFvRRmb8T2.FhhNokcvxL52GrZPZEN+aG.QFpWIj1SKaFIwOSFK05GZ0zjDyOwO5hqMu2J4ol2iC4=")
cl.loginResult()

ki1 = LINETCR.LINE()
ki1.login(token="EqxzjmMmQKLcxM2bZaR1.bl1TMoqGg0FCSxp600BKyq.lot2fPN9XC/fb7LzAVm0trzWPB5HVEKJ6ugpOjtrzfw=")
ki1.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="EqjiUPchpnQe5hNEuWif.PD9pypV01tj5taeuIV5XRW.RMqIbQqYIay3ITpb1fUVjwjf8izR5cn59OSGLjdKYmg=")
ki2.loginResult()

ki3 = LINETCR.LINE()
ki3.login(token="Eq9hsNKIqxNIaQuQJ9vc.ewWRUg8Ug3XH1skJNcEkBa.A12cfxyAvt6T6aPIVFsAHrmFVWy2zz+YIK1Tz6magD0=")
ki3.loginResult()

ki4 = LINETCR.LINE()
ki4.login(token="EqpHWPaA0EGicpcmQrgd.sxU2uxBXkcWp9iI63Pk/Nq.CdCRWN9sBigexI2RLrIIaELPoxwD77SEqSvEww70u6Q=")
ki4.loginResult()

ki5 = LINETCR.LINE()
ki5.login(token="EqtiBqeC5GtQOIpMKRUc.ai72d60FqxPhv+oPYC4AZa.ezi8S3s/tGDbWLV0BUMEZ3gd2Fn2+uPv3Yxw50KXDbo=")
ki5.loginResult()
...
targets = []
mid = cl.getProfile().mid
Bots = [Amid1,Amid2,Amid3,Amid4,Amid5,Amid6,Amid7,Amid8,Amid9,Amid10]
self = "uc247e89c9726f0aa4dcd7a7d917d63bd"
admin = "uc247e89c9726f0aa4dcd7a7d917d63bd"
admsa = "uc247e89c9726f0aa4dcd7a7d917d63bd"
owner = "uc247e89c9726f0aa4dcd7a7d917d63bd"
adminMID = "uc247e89c9726f0aa4dcd7a7d917d63bd"
Creator="uc247e89c9726f0aa4dcd7a7d917d63bd"
wait = {
    "alwayRead":False,
    "detectMention":True,
    "kickMention":False,
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = [""]
                     ret_ = "[โปรแกรมตอบกลับอัตโนมัติ] : บอทคางคาก สวัสดีครับ เจ้านายสุดหล่อยังไม่ว่าง มีไรพิมพ์บอกคางคากได้เลยครับ " + random.choice(balas)
