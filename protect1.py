...
ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token='ErV1pugVOBTbfjR5kuXb.thEbgORJZ5EqXYnQKch5kW.YCUszeW1qVKJuQ2hqq941buKt971ImihTYsN8Wu4cJ4=')
ki.loginResult()
print "Ki-Login Success\n"

kk = LINETCR.LINE()
#kk.login(qr=True)
kk.login(token='EryDgrC9FntGeEypqhw9.ARWWQwWlFLlktlE/A8VSMq.5hHgiir3w+gxZGC1fOxaXjNZa0Glv6LH+OhRloU9qzI=')
kk.loginResult()
...
╚════════════════════
"""
tjia="u7c71e738a0955e5e76811ce9cde9ff02"
...
self = "u7c71e738a0955e5e76811ce9cde9ff02"
...
wait = {
    ...
    "comment4":"Nice Kak (^_^)",
    "comment5":"Bot Auto Like ©By : •─ ͜͡✫ѕєʟғвот[☆-❍ণហ ざণاعနัю❍ีざန-☆]κɪcκєʀ ͜͡✫─•",
    "commentOn":True,
    "acommentOn":False,
    "bcommentOn":False,
    "ccommentOn":False,
    ...
    try:
        ...
        if op.type == 17:
            if wait["Notifed"] == True:
                ...
                cl.sendText(op.param1, "􂜁􀆄􏿿 อย่าลืมปิดเสียงการเเจ้งเตือนด้วยนะ 􂜁􀆄􏿿\n\n[•─ ͜͡✫ѕєʟғвот[☆-❍ণហ ざণاعနัю❍ีざန-☆]κɪcκєʀ ͜͡✫─•]")
        ...
        if op.type == 17:
            if wait["Notifedbot"] == True:
                if op.param2 in Bots:
                    return
                ki.sendText(op.param1,cl.getContact(op.param2).displayName + "\n\n􀜁􀄁􏿿􂘁􀄗􏿿􂘁􀄅􏿿􂘁􀄌􏿿􂘁􀄃􏿿􂘁􀄏􏿿􂘁􀄍��􂘁􀄅􏿿􀜁􀄁􏿿\n\n[•─ ͜͡✫ѕєʟғвот[☆-❍ণហ ざণاعနัю❍ีざန-☆]κɪcκєʀ ͜͡✫─•์]")
                print "MEMBER HAS JOIN THE GROUP"
	 ...
	 if wait["Ghost"] == True:
		...
		cl.sendText(msg.to,"Itu Majikan Kami (^_^)")
                ...
                msg.contentType = 13
                admin1 = "u7c71e738a0955e5e76811ce9cde9ff02"
                admin2 = ""
                admin3 = ""
                msg.contentMetadata = {'mid': tjia}
...
#                cl.sendText(msg.to,"╔═════════════════════════\n""║           ☆☞ S T A T U S ☜☆\n""╠═════════════════════════\n"+md+"╚═════════════════════════")
		...
		if midd not in admin:
		    ...
		    cl.sendText(msg.to,"Admin Detected")
                ...
                midd = "u7c71e738a0955e5e76811ce9cde9ff02"
                random.choice(KAC).inviteIntoGroup(msg.to,[midd])
		...
		if msg.from_ in Creator:
	        ...
	        if msg.from_ in Creator:
              ...
              if msg.from_ in Creator:
                ...
                ki.sendText(msg.to,"Bot 💀6💀 \n•─ ͜͡͡✫ѕєʟғвот[☆-❍ণហ ざণاعနัю❍ีざန-☆]κɪcκєʀ ͜͡✫─•")
