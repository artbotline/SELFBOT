...
ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token='ErOGOvfInsBY1Gxdqk5e.Kvau/VcPeZfM1YcbhLVitG.e6qgtscZO1sHSupwyS/SIGK537BIkqG4bm6ME74PlIo=')
ki.loginResult()
...
km = LINETCR.LINE()
#km.login(qr=True)
km.login(token='Er7apt3DE2PV8YPtYNo6.cuUzgHyUWFbMQ7xPJaq0XG.RiAJqOjwgiQyku8optk3LhKtS7AVoKsvxIufnAwSoPw=')
km.loginResult()
