...
cl = LINETCR.LINE()
cl.login(token="ErF02vpS7ElQvNVxKhM8.w029Gt6EFuupMCBP3LgQka.4gfTQPKpMuJbx/lbysCLIxkCSPxa+fOTlER2ECYEtk4=")
cl.loginResult()
...
targets = []
mid = cl.getProfile().mid
Bots = ["u5b4dbd813e9e7d450f99c6e9de51aa28",mid]
self = ["u5b4dbd813e9e7d450f99c6e9de51aa28",mid]
admin = "u5b4dbd813e9e7d450f99c6e9de51aa28"
admsa = "u5b4dbd813e9e7d450f99c6e9de51aa28"
owner = "u5b4dbd813e9e7d450f99c6e9de51aa28"
adminMID = "u5b4dbd813e9e7d450f99c6e9de51aa28"
Creator="u5b4dbd813e9e7d450f99c6e9de51aa28"
wait = {
    "alwayRead":False,
    "detectMention":True,
    "kickMention":False,
    ...
    'timeline':True,
    'autoAdd':False,
    'message':"Thanks for add Me MY NAME IS ☆-❍ণហ ざণاعနัю❍ีざန-\n http://line.me/ti/p/_9io7edD7W",
    "lang":"JP",
    "comment":"AutoLike by ☆-❍ণហ ざণاعနัю❍ีざန-\n http://line.me/ti/p/_9io7edD7W",
    "commentOn":False,
    "acommentOn":False,
    "bcommentOn":False,
    "ccommentOn":False,
...
#----------------------------------------------------------------------------
                ...
                msg.contentType = 13
                adm = 'u915014faf0a9133166d720811e5bc84e'
                ...
                #        ki8.acceptGroupInvitationByTicket(msg.to,Ticket)
                 #       ki9.acceptGroupInvitationByTicket(msg.to,Ticket)
                  #      ki10.acceptGroupInvitationByTicket(msg.to,Ticket)
                        ...
                        ki1.sendText(msg.to,"[☆-❍ণហ ざণاعနัю❍ีざန-]")
                        ki2.sendText(msg.to,"[Do not think  will try.]")
                        ki3.sendText(msg.to,"[☆-❍ণហ ざণاعနัю❍ีざန-]")
   ...
   #                     ki8.leaveGroup(msg.to)
    #                    ki9.leaveGroup(msg.to)
     #                   ki10.leaveGroup(msg.to)
                ...
                cl.sendText(msg.to,"""[☆-❍ণហ ざণاعနัю❍ีざန-]\n\n
Phet Tema Hack Bot
คำสั่งบอท siri
