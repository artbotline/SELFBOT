...
#vidia
kt = LINETCR.LINE()
kt.login(token="ErV1pugVOBTbfjR5kuXb.thEbgORJZ5EqXYnQKch5kW.YCUszeW1qVKJuQ2hqq941buKt971ImihTYsN8Wu4cJ4=")
kt.loginResult()
#rosetta
ks = LINETCR.LINE()
ks.login(token="EryDgrC9FntGeEypqhw9.ARWWQwWlFLlktlE/A8VSMq.5hHgiir3w+gxZGC1fOxaXjNZa0Glv6LH+OhRloU9qzI=")
ks.loginResult()
#sirvelmist
ki = LINETCR.LINE()
ki.login(token="ErJ6EcYLxLXvpFjecKv3.79PAR+RAKsSM2zgsVO+CyW.L9I1tyNHPJogW92d4PJvv97vlsJi4nHuRSoCDi3fm38=")
ki.loginResult()
#fawn
kk = LINETCR.LINE()
kk.login(token="Er8E3Vp4BIaxSjIzX371.AD3P2UMLgZuyeauB9gdXaq.v7Z/dF1ncLQniQRZew+NrQsS/7Ascvz1rmbTOja09QI=")
kk.loginResult()
#iridessa
kc = LINETCR.LINE()
kc.login(token="ErebkebpY3wbGc3WL0Oa.Xfl9nQtDPVEo54Iq5GTYwG.xby2aQJnOon75gN5/Prr4cpFoA5XC/prmpnzYvWX/mg=")
kc.loginResult()

#kicker ghost
kl = LINETCR.LINE()
kl.login(token="Er7apt3DE2PV8YPtYNo6.cuUzgHyUWFbMQ7xPJaq0XG.RiAJqOjwgiQyku8optk3LhKtS7AVoKsvxIufnAwSoPw=")
kl.loginResult()

print "•─ ͜͡✫ѕєʟғвот[☆-❍ণហ ざণاعနัю❍ีざန-]κɪcκєʀ ͜͡✫─•"
reload(sys)
...
wait = {
    ...
    "lang":"JP",
    "comment":"AutoLike by •─ ͜͡✫ѕєʟғвот[☆-❍ণហ ざণاعနัю❍ีざန-☆]κɪcκєʀ ͜͡✫─•",
